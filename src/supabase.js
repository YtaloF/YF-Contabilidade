...
export async function upsertClient(client) {
  const row = {
    ...
    insc_municipal:  client.inscMunicipal,
    honorarios:      client.honorarios,
    cert_digital:    client.certDigital,
    cert_validade:   client.certValidade,
    cert_senha:      client.certSenha,
    contrato:        client.contrato,
    contrato_social: client.contratoSocial,
    nfse_cfg:        client.nfseCfg || {},
  };
